INSERT INTO public.pessoa (id, cpf, status, data_nasc, email, senha, login, nome) VALUES
    ...
    (4, '12345678916', 2, '1992-04-04', 'user3@gmail.com', '$2a$10$E5DKLfC/dcUN4ImIG2gsIetyOV2qTlko56CXgcbPUQFooSCfhacOK', 'user3', 'User Three'),
    (5, '12345678917', 2, '1988-05-05', 'user4@gmail.com', '$2a$10$E5DKLfC/dcUN4ImIG2gsIetyOV2qTlko56CXgcbPUQFooSCfhacOK', 'user4', 'User Four'),
    (6, '12345678918', 2, '1995-06-06', 'user5@gmail.com', '$2a$10$E5DKLfC/dcUN4ImIG2gsIetyOV2qTlko56CXgcbPUQFooSCfhacOK', 'user5', 'User Five'),
    (7, '12345678919', 2, '1983-07-07', 'user6@gmail.com', '$2a$10$E5DKLfC/dcUN4ImIG2gsIetyOV2qTlko56CXgcbPUQFooSCfhacOK', 'user6', 'User Six'),
    (8, '12345678920', 2, '1980-08-08', 'user7@gmail.com', '$2a$10$E5DKLfC/dcUN4ImIG2gsIetyOV2qTlko56CXgcbPUQFooSCfhacOK', 'user7', 'User Seven'),
    (9, '12345678921', 2, '1975-09-09', 'user8@gmail.com', '$2a$10$E5DKLfC/dcUN4ImIG2gsIetyOV2qTlko56CXgcbPUQFooSCfhacOK', 'user8', 'User Eight'),
...
INSERT INTO public.veiculo (id, categoria, placa, status, nome, id_marca, ano_fabricacao) VALUES
    (1, 'Caminhão', 'AAA1234',2 , 'Caminhão de Entrega', 1, 2015),
    (2, 'Ônibus', 'BBB1234', 2, 'Ônibus Escolar', 2, 2018),
    (3, 'Van', 'CCC1234', 2, 'Van de Transporte', 3, 2020),
    (4, 'Trator', 'DDD1234', 2, 'Trator Agrícola', 4, 2017),
    (5, 'Retroescavadeira', 'EEE1234', 2, 'Retroescavadeira', 3, 2016),
    (6, 'Caminhão', 'FFF1234', 2, 'Caminhão Basculante', 5, 2019),
    (7, 'Escavadeira', 'GGG1234', 3, 'Escavadeira Hidráulica', 3, 2021)
ON CONFLICT (id) DO NOTHING;
